describe('Armor of the Fallen', function () {
    integration(function () {
        beforeEach(function () {
            ...
            this.attachedTo = this.player2.findCardByName('benevolent-host');
        ...
        it('should prompt you to remove characters', function () {
            ...
            this.initiateConflict({
                ...
                defenders: [this.whisperer, this.brash, this.challenger, this.attachedTo, this.kuwanan],
                type: 'military'
            });
            this.player2.pass();
        ...
        it('should prompt you to choose a participating character with cost <= characters chosen', function () {
            ...
            expect(this.player1).not.toBeAbleToSelect(this.attachedTo);

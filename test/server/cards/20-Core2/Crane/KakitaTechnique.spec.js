        ...
        describe('Non duel effect', function () {
            ...
            it('lasting delayed effect', function () {
                ...
                expect(this.getChatLogs(10)).toContain(
                    'player1 plays Kakita Technique to give Doji Kuwanan +1military and +1political after each event they play'
                );
                expect(this.getChatLogs(10)).toContain(
            ...
            it('extra actions', function () {
                ...
                expect(this.getChatLogs(10)).toContain(
                    'player2 plays Kakita Technique to give Kakita Toshimoko +1military and +1political after each event they play and take 4 additional actions'
                );

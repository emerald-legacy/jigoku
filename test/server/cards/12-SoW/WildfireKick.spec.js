describe('Wildfire Kick', function() {
    integration(function() {
        describe('targeting rules', function() {
            beforeEach(function() {
                this.setupTest({
                    phase: 'conflict',
                    player1: {
                        inPlay: ['togashi-initiate', 'doji-challenger'],
                ...
                this.ancient = this.player2.findCardByName('ancient-master');
            });

            it('should not allow targeting an opponent\'s monk', function() {
                this.noMoreActions();
                this.initiateConflict({
                    attackers: [this.initiate, this.challenger],
                    defenders: [this.ancient],
                    type: 'military'
                });
                ...
                expect(this.player1).not.toBeAbleToSelect(this.ancient);
            });
        });

...
class PillowBook extends DrawCard {
    ...
    setupCardAbilities() {
        this.action({
            ...
            condition: (context: AbilityContext<this>) => !!context.source.attachedCharacter && (context.source.attachedCharacter as DrawCard).isParticipating() && context.player.conflictDeck.length > 0,

...
class PillowBook extends DrawCard {
    ...
    setupCardAbilities() {
        this.action({
            ...
            condition: (context: AbilityContext<this>) => !!context.source.parentCharacter && (context.source.parentCharacter as DrawCard).isParticipating() && context.player.conflictDeck.length > 0,

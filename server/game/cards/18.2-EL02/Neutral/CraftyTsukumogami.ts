                    ...
                    AbilityDsl.actions.cardLastingEffect(context => ({
                        ...
                        effect: [
                            ...
                            AbilityDsl.effects.gainAbility(AbilityType.ForcedReaction, {
                                ...
                                when: {
                                    onConflictDeclared: (event: EventPayload<typeof EventName.OnConflictDeclared>, context: AbilityContext<this>) => !!context.source.attachedTo && (context.source.attachedTo as unknown) === event.ring
                                },

...
class LiarsMask extends DrawCard {
    ...
    setupCardAbilities() {
        this.action({
            ...
            gameAction: AbilityDsl.actions.selectToken((context: AbilityContext<this>) => ({
                card: context.source.attachedCharacter as DrawCard,
            ...
            effectArgs: (context: AbilityContext<this>) => [context.source.attachedCharacter as DrawCard]
        });
    }

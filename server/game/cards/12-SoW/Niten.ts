...
const nitenCaptureParentCost = function(): Cost {
    return {
        ...
        resolve: function(context: AbilityContext) {
            context.costs.nitenCaptureParentCost = (context.source as DrawCard).attachedCharacter;
        },
        pay: function() {
        }
    };
    ...
    setupCardAbilities() {
        ...
        this.action({
            ...
            target: {
                ...
                cardCondition: (card, context) => card.canAttach(context.source.attachedCharacter ?? undefined) || card.canAttach(context.costs.nitenCaptureParentCost as DrawCard)
            },

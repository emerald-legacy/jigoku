        ...
        this.action({
            ...
            target: {
                ...
                gameAction: AbilityDsl.actions.sequential([
                    AbilityDsl.actions.selectRing((context: any) => ({
                        activePromptTitle: 'Choose an unclaimed ring to move fate to',
                        ringCondition: (ring: any) => context.ring.fate > 0 && ring.isUnclaimed() && ring !== context.ring,
                    ...
                    AbilityDsl.actions.gainHonor((context: any) => ({ target: context.player }))
                ])
            },
            effect: '{1}{2}{3}',
            effectArgs: (context: any) => (context.ring && context.ring.fate > 0) ?
